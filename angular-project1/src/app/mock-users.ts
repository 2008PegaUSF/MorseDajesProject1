...
export const USERS: user[] = [
    ...
    { id:3, firstName:'Morgen',lastName:'Lanueva',userType:'Department Head',balance: 0,reportsto: 4,email:'Venmoyourbenco@gmail.com', username: 'Morgen',password:'DeptDeputy'},
  ];